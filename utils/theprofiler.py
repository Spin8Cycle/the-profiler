...
class TheProfiler(data_utils.DataLoader, 
    ...
    def __init__(self, file: Optional[str]=None, file_repo: Optional[str]=None, 
                 df: Optional[pd.DataFrame]=None, **kwargs):
        super().__init__(file, file_repo, df, **kwargs)
    ...
    def summary_tables(self, main: bool=True, **kwargs):
    ...
    def value_tables(self, main: bool=True, **kwargs):
